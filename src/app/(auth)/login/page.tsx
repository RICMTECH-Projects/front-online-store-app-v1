			...
			<div className="hidden lg:block relative w-1/2">
				...
				<div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-12">
					...
					<p className="mt-6 text-white/60 text-center text-sm max-w-sm font-inter leading-relaxed">
						Diseño urbano, esencia única. Inicia sesión para acceder a tu cuenta y explorar lo nuevo.
					</p>
				</div>
			</div>
			...
			<div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12">
				<div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
					...
					<form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
						...
						<button
							type="submit"
							className="w-full py-3.5 bg-foreground text-background font-medium text-sm uppercase tracking-wider hover:opacity-90 transition-opacity mt-1"
						>
							Iniciar sesión
						</button>
					</form>
